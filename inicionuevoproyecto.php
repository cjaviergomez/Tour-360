...
<!-- Modal -->
    <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
         ...
         <br> <br> <br> 
          <form action="iniciodb.php" method="post">
          <label for="nombreproyecto">Nombre del Proyecto</label>
          <input type="text" id="nombreproyecto" class="nombreproyecto" name = "nombreproyecto" maxlength="256" required />
          <br>
          <label for="desproyecto">Descripción del Proyecto</label>
          <input type="text" id="desproyecto" class="desproyecto" name = "desproyecto" maxlength="456" required />
          <br>
