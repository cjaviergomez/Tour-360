...
if (isset($_SESSION["nombre"])){ //Si la variable de la sesión existe, eso quiere decir que ya se inicio sesión antes

 header("Location: inicio.php"); //La redirijo a la página principal.
...
<head>
  <meta charset="UTF-8">
  <title>Tour 360 | Login </title>
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/meyer-reset/2.0/reset.min.css">
  <link rel="stylesheet" href="css/style.css">  <!--Estilo de la página en general, tanto del formulario como demás cosas -->
  <link rel="shorcut icon" href="img/logoGeomatica.png"> <!--Logo de la página -->
  <script type="text/javascript" src="js/TweenMax.min.js"></script><!--Libreria para animacion del formulario -->
</head>
...
<body>
  ...
  <form action="validar_usuario.php" method="post">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="email" class="email" name = "email" maxlength="256"/>
		<p class="helper helper1">Usuario</p>
		<span class="indicator"></span>
	</div>
	<div class="inputGroup inputGroup2">
		<label for="password">Password</label>
		<input type="password" id="password" class="password" name = "password" autocomplete="off" />
	</div>
...
<script  src="js/index.js"></script> <!--Implementación de la libreria anterior -->
</body>
</html>
